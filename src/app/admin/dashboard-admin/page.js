                          ...
                          <td colSpan="4" className="py-4">
                            <div className="flex items-center justify-between px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
                              <div className="flex items-center text-gray-600">
                                ...
                                <span className="text-sm">Menampilkan 3 dari {bookings.length} pengguna</span>
                              </div>
                  ...
                  {obatList.length > 3 && (
                    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
                      <div className="flex items-center text-gray-600">
                        ...
                        <span className="text-sm">Menampilkan 3 dari {obatList.length} list obat</span>
                      </div>
                      <div className="text-teal-600 text-sm font-medium">+{obatList.length - 3} lainnya</div>
                    </div>
                  )}
                </div>
                <div className="mt-6 pt-4 border-t border-gray-100">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-linear-to-r from-indigo-500 to-purple-500 text-white rounded-lg hover:from-indigo-600 hover:to-purple-600 transition duration-200 flex items-center space-x-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
